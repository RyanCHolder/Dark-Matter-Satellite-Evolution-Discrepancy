...
DOUBLE rhoABG(DOUBLE, const SI (*));
DOUBLE drhoABGdr(DOUBLE, const SI (*));
DOUBLE d2rhoABGdr2(DOUBLE, const SI (*));
DOUBLE etaABG(DOUBLE, const SI (*));
DOUBLE detaABGdr(DOUBLE, const SI (*));
DOUBLE tauABG(DOUBLE, const SI (*));
DOUBLE MencInnerABG(DOUBLE, const SI (*));
